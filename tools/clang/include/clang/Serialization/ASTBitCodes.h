...
#include "clang/Basic/OpenCLImageTypes.def"
      /// \brief The '__uint48_t' type.
      PREDEF_TYPE_UINT48_ID = 81,
      /// \brief The '__int48_t' type.
      PREDEF_TYPE_INT48_ID = 82
    };
    ...
    enum PredefinedDeclIDs {
      ...
      /// \brief The signed 48-bit integer type.
      PREDEF_DECL_INT_48_ID = 17,

      /// \brief The unsigned 48-bit integer type.
