...
class ASTContext : public RefCountedBase<ASTContext> {
  ...
  /// \brief The typedef for the __int48_t type.
  mutable TypedefDecl *Int48Decl = nullptr;

  /// \brief The typedef for the __uint48_t type.
...
public:
  ...
  CanQualType SignedCharTy, ShortTy, IntTy, LongTy, Int48Ty, LongLongTy, Int128Ty;
...
#include "clang/Basic/OpenCLImageTypes.def"
  ...
  /// \brief Retrieve the declaration for the 48-bit signed integer type.
  TypedefDecl *getInt48Decl() const;

  /// \brief Retrieve the declaration for the 48-bit unsigned integer type.
