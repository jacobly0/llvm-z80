...
SDValue SelectionDAGLegalize::ExpandIntLibCall(SDNode* Node, bool isSigned,
  ...
  case MVT::i24:  LC = Call_I24; break;
...
SelectionDAGLegalize::ExpandDivRemLibCall(SDNode *Node,
  ...
  case MVT::i24:  LC= isSigned ? RTLIB::SDIVREM_I24 : RTLIB::UDIVREM_I24; break;
...
bool SelectionDAGLegalize::ExpandNode(SDNode *Node) {
  ...
  case ISD::SHL: {
    ...
    if (VT.isVector()) {
      ...
      SDValue Result =
        DAG.getBuildVector(Node->getValueType(0), dl, Scalars);
...
void SelectionDAGLegalize::ConvertNodeToLibcall(SDNode *Node) {
  ...
  case ISD::AND:
    Results.push_back(ExpandIntLibCall(Node, false,
                                       RTLIB::AND_I8,  RTLIB::AND_I16,
                                       RTLIB::AND_I24, RTLIB::AND_I32,
                                       RTLIB::AND_I64, RTLIB::AND_I128));
    break;
  case ISD::OR:
    Results.push_back(ExpandIntLibCall(Node, false,
                                       RTLIB::OR_I8,  RTLIB::OR_I16,
                                       RTLIB::OR_I24, RTLIB::OR_I32,
                                       RTLIB::OR_I64, RTLIB::OR_I128));
    break;
  case ISD::XOR:
    Results.push_back(ExpandIntLibCall(Node, false,
                                       RTLIB::XOR_I8,  RTLIB::XOR_I16,
                                       RTLIB::XOR_I24, RTLIB::XOR_I32,
                                       RTLIB::XOR_I64, RTLIB::XOR_I128));
    break;
  case ISD::SHL:
    Results.push_back(ExpandIntLibCall(Node, false,
                                       RTLIB::SHL_I8,  RTLIB::SHL_I16,
                                       RTLIB::SHL_I24, RTLIB::SHL_I32,
                                       RTLIB::SHL_I64, RTLIB::SHL_I128));
    break;
  case ISD::SRA:
    Results.push_back(ExpandIntLibCall(Node, false,
                                       RTLIB::SRA_I8,  RTLIB::SRA_I16,
                                       RTLIB::SRA_I24, RTLIB::SRA_I32,
                                       RTLIB::SRA_I64, RTLIB::SRA_I128));
    break;
  case ISD::SRL:
    Results.push_back(ExpandIntLibCall(Node, false,
                                       RTLIB::SRL_I8,  RTLIB::SRL_I16,
                                       RTLIB::SRL_I24, RTLIB::SRL_I32,
                                       RTLIB::SRL_I64, RTLIB::SRL_I128));
    break;
  case ISD::SREM:
    Results.push_back(ExpandIntLibCall(Node, true,
                                       RTLIB::SREM_I8,  RTLIB::SREM_I16,
                                       RTLIB::SREM_I24, RTLIB::SREM_I32,
                                       RTLIB::SREM_I64, RTLIB::SREM_I128));
    break;
  case ISD::UREM:
    Results.push_back(ExpandIntLibCall(Node, false,
                                       RTLIB::UREM_I8,  RTLIB::UREM_I16,
                                       RTLIB::UREM_I24, RTLIB::UREM_I32,
                                       RTLIB::UREM_I64, RTLIB::UREM_I128));
    break;
  case ISD::SDIV:
    Results.push_back(ExpandIntLibCall(Node, true,
                                       RTLIB::SDIV_I8,  RTLIB::SDIV_I16,
                                       RTLIB::SDIV_I24, RTLIB::SDIV_I32,
                                       RTLIB::SDIV_I64, RTLIB::SDIV_I128));
    break;
  case ISD::UDIV:
    Results.push_back(ExpandIntLibCall(Node, false,
                                       RTLIB::UDIV_I8,  RTLIB::UDIV_I16,
                                       RTLIB::UDIV_I24, RTLIB::UDIV_I32,
  ...
  case ISD::MUL:
    Results.push_back(ExpandIntLibCall(Node, false,
                                       RTLIB::MUL_I8,  RTLIB::MUL_I16,
                                       RTLIB::MUL_I24, RTLIB::MUL_I32,
