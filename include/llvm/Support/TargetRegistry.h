...
private:
  ...
  OMFStreamerCtorTy OMFStreamerCtorFn = nullptr;
...
public:
  ...
  MCStreamer *createMCObjectStreamer(const Triple &T, MCContext &Ctx,
    ...
    case Triple::Wasm:
      ...
      break;
    case Triple::OMF:
      if (OMFStreamerCtorFn)
        S = OMFStreamerCtorFn(T, Ctx, std::move(TAB), OS, std::move(Emitter),
                              RelaxAll);
      else
        S = createOMFStreamer(Ctx, std::move(TAB), OS, std::move(Emitter),
                              RelaxAll);
      break;
    }
